...
Once inside the folder, typing `ls` again shows that we have multiple files to analyze (**note** that these filenames start with a dash! [Level 2](https://github.com/Nanospaziale/OTW-WriteUps/blob/main/bandit/level02.md)).  
...
<details>
  <summary>
  Here's the explanation of the command I used above:
